...
CombuLocEN = {["lockon"] = "|cff00ffffCombustionHelper locked|r",
			...
			["lbon"] = "|cff00ffffEarly LB refresh mode enabled|r",
			["lboff"] = "|cff00ffffEarly LB refresh mode disabled|r",
			...
			["lbtrackon"] = "|cff00ffffLiving Bomb tracker enabled|r",
			["lbtrackoff"] = "|cff00ffffLiving Bomb tracker disabled|r",
			...
			["lbrefresh"] = "|cffff0000 -- You refreshed your Living bomb on |cffffffff%s |cffff0000too early. --|r",
			["lbmiss"] = "|cffff00ff -- Living Bomb cast on |cffffffff%s |cffff00ffmissed !! --",
			...
			["lbreport"] = "|cffff0000 -- Earlier Living bomb refresh for this fight : |cffffffff%d |cffff0000--|r",
			["pyroreport"] = "|cffff0000 -- Hot Streak gained : |cffffffff%d  |cffff0000- Hot Streak cast : |cffffffff%d  / %d%% |cffff0000--|r",
...
combuoptioninfotableEN = {
	...
	["CombuLBtargetButton"] = "When disabled, this settings hide the multi target Living Bomb tracker when you only have a Living Bomb active and it's on your target.",
	...
	["CombuBorderDropDown"] = "Use the Dropdown menu to choose the border for the main frame and LB/FS tracker frame.",
	["CombuBorderInfo"] = "Use the Dropdown menu to choose the border for the main frame and LB/FS tracker frame.",
	["CombuBackgroundDropDown"] = "Use the Dropdown menu to choose the background for the main frame and LB/FS tracker frame.",
	["CombuBackgroundInfo"] = "Use the Dropdown menu to choose the background for the main frame and LB/FS tracker frame.",
	["CombuEdgeSizeSlider"] = "Use this slider to choose the size of the borders for the main frame and LB/FS tracker frame.",
	["CombuTileSizeSlider"] = "Use this slider to choose the size of the texture tiles used in the background for the main frame and LB/FS tracker frame. This slider is used only if the Tiles button is checked.",
	["CombuTileButton"] = "Enable or disable the tiles for the background for the main frame and LB/FS tracker frame. When enabled, the chosen background will be repeated according to the size chosen in the tile size slider.",
...
CombuOptLocEN = {
	...
	["ComburefreshButton"] = "Early/Missed LB warning",
	...
	["CombuLBtrackerButton"] = "Enable Living Bomb Tracker",
	["CombuLBtargetButton"] = "Always show LB on target",
	["LBtrackerPosition"] = "LB/FS tracker position :",
	...
	["Combubgcolorimpact"] = "Background color (Impact up)",
